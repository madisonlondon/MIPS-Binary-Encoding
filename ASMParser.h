...
class ASMParser{
 ...
 private:
  ...
  // Given a valid R-Type instruction, returns a string of the encoded instruction
  string encodeR(Instruction i);

  // Given a valid I-Type instruction, returns a string of the encoded instruction
  string encodeI(Instruction i);

  // Given a valid J-Type instruction, returns a string of the encoded instruction
  string encodeJ(Instruction i);

  // Given a valid instruction, returns a string of the encoded rs Register
  string encodeRS(Instruction i);

  // Given a valid instruction, returns a string of the encoded rt Register
  string encodeRT(Instruction i);

  // Given a valid instruction, returns a string of the encoded rd Register
  string encodeRD(Instruction i);
};
